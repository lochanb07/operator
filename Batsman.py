...
def main():
    # Input for the number of No-balls
    no_balls = int(input())
    # Input for the number of wides
    wides = int(input())
    # Input for the number of byes
    byes = int(input())
    # Input for the number of leg-byes
    leg_byes = int(input())
    # Input for the number of penalty runs
    penalties = int(input())
    
    # Calculate the total runs contributed by extras
    total_extras = (no_balls + wides + byes + leg_byes + (penalties * 5))
    
    # Display the total runs from extras
    print(total_extras)
